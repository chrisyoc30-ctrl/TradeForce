...
export const verifyFormSchema = z
  .object({
    ...
    business_structure: z.enum(["sole_trader", "limited_company", "partnership"], {
      required_error: "Select your business structure",
    }),
    ...
    id_type: z.enum(["driving_licence", "passport"], {
    ...
    confirm_accurate: z.literal(true, {
      errorMap: () => ({ message: "You must confirm your information is accurate" }),
    }),
    confirm_authorities: z.literal(true, {
      errorMap: () => ({
        message: "You must agree to verification with issuing authorities",
      }),
    }),
  })
